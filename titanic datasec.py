...
df.drop(['Name', 'SibSp', 'Parch', 'Cabin', 'Ticket'], axis=1, inplace=True)
...
print(df.head())
#Spliting data
X_data = df.drop('Survived', axis=1)#data
...
#visuvalizing content
importances = model.feature_importances_
feat_names = X_data.columns  # or X_train.columns
#Create the bar plot
plt.figure(figsize=(8, 5))
sns.barplot(x=importances, y=feat_names, color='steelblue')  #use a solid color
